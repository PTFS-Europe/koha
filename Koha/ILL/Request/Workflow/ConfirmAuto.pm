...
Object-oriented class that provides the AutoILLBackend confirmation screen

=head1 DESCRIPTION

This class provides the ability to verify if it should render the AutoILLBackend
...
sub show_confirm_auto {
    ...
    return
        ...
        # AutoILLBackend enabled
        C4::Context->preference("AutoILLBackend")
