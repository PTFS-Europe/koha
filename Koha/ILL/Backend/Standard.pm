...
sub create {
    ...
    if ( !$stage || $stage eq 'init' ) {
        ...
        # my $unauthenticated_request = C4::Context->preference("OpacUnauthenticatedILLRequest") && !$other->{'cardnumber'};
        my $unauthenticated_request = 1 && !$other->{'cardnumber'};
...
sub add_request {
    ...
    # TODO: Uncomment below when sys pref exists
    # my $unauthenticated_request =
    #     C4::Context->preference("OpacUnauthenticatedILLRequest") && !$params->{other}->{'cardnumber'};
    my $unauthenticated_request =
        1 && !$params->{other}->{'cardnumber'};
...
sub _unauth_request_data_check {
    ...
    # return 1 unless C4::Context->preference("OpacUnauthenticatedILLRequest");
