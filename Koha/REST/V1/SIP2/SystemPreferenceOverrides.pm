...
sub get {
    ...
    return try {
        my $syspref_override = $c->objects->find( Koha::SIP2::SystemPreferenceOverrides->search, $c->param('sip_system_preference_override_id') );
...
sub update {
    ...
    my $syspref_override = Koha::SIP2::SystemPreferenceOverrides->find( $c->param('sip_system_preference_override_id') );
