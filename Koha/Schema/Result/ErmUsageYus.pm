...
=head2 ytd_html_count

  data_type: 'integer'
  is_nullable: 1

full text html request count for the title
...
full text pdf request count for the title
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6MFggS434nCDxadnnEMaZw
