...
CREATE TABLE `erm_counter_files` (
  ...
  `date` date DEFAULT NULL COMMENT 'counter file date',
  `filename` varchar(80) DEFAULT NULL COMMENT 'name of the counter file',
  `file_content` longtext DEFAULT NULL COMMENT 'content of the counter file',
...
--
-- Table structure for table `erm_harvesters`
--

DROP TABLE IF EXISTS `erm_harvesters`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `erm_harvesters` (
  ...
  `harvest_start` date DEFAULT NULL COMMENT 'start date of the harvester',
  `harvest_end` date DEFAULT NULL COMMENT 'end date of the harvester',
  `customer_id` int(11) DEFAULT NULL COMMENT 'sushi customer id',
  `requestor_id` int(11) DEFAULT NULL COMMENT 'sushi requestor id',
...
--
-- Table structure for table `erm_platforms`
--

DROP TABLE IF EXISTS `erm_platforms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `erm_report_types`
--

DROP TABLE IF EXISTS `erm_report_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `erm_report_types` (
  `erm_report_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  `harvester_id` int(11) DEFAULT NULL COMMENT 'foreign key to erm_harvester',
  `type` varchar(255) DEFAULT NULL COMMENT 'report type',
  PRIMARY KEY (`erm_report_id`),
  CONSTRAINT `erm_report_type_ibfk_1` FOREIGN KEY (`harvester_id`) REFERENCES `erm_harvesters` (`erm_harvester_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
