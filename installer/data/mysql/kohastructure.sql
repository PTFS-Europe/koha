...
CREATE TABLE `sip_accounts` (
  ...
  `encoding` varchar(10) NOT NULL DEFAULT 'utf8',
  `error_detect` varchar(10) NULL DEFAULT 'enabled' COMMENT 'THIS SHOULD PROBABLY BE TINYINT',
  ...
  `login_id` varchar(255) NULL COMMENT 'PREVIOUSLY id in Sipconfig.xml',
...
CREATE TABLE `sip_institutions` (
  ...
  `offline` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Previously attribute of "policy" in SIPconfig.xml',
  ...
  `status_update` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Previously attribute of "policy" in SIPconfig.xml',
