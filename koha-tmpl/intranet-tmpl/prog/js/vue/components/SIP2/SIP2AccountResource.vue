...
export default {
        ...
        return {
            resourceAttrs: [
                ...
                },
                {
                    ...
                    options: [
                        { value: "shelving_location", description: __("Shelving location") },
                        { value: "collection_code", description: __("Collection code") },
                    ],
                    requiredKey: "value",
                    selectLabel: "description",
                    group: "Details",
                ...
                },
                {
                    ...
                    group: "Details",
                    toolTip: __("Item types that can only do in house checkouts via SIP self check machines")
                },
                {
                    ...
                    group: "Details",
                    toolTip: __("Patron categories that can only do in house checkouts via SIP self check machines")
                },
                {
                    ...
                    group: "Details",
                    toolTip: __("If a patron has more than a certain number of lost items (default is 1), a flag is set"),
                    placeholder: 1,
                },
                {
                    ...
                    group: "Details",
                    toolTip: __("Specifies the minimum value of a lost item to be counted towards the lost_block_checkout threshold."),
                    placeholder: 1,
                },
                {
                ...
                },
               {
                    ...
                    group: "Details",
                    toolTip: __("Only required if system preference UseCashRegisters is enabled")
                },
                {
                    ...
                    selectLabel: "description",
                    group: "Details",
                    toolTip: __("If set, the item information SIP message will update the datelastseen field for items. For lost items, will either keep them as'lost' or mark them as 'found' depending on the setting")
                },
                {
                ...
                },
                {
                    ...
                    showElement: {
                        ...
                        hidden: account =>
                            !!account.sort_bin_mappings?.length,
                        columns: [
                            {
                                name: __("Mapping"),
                                value: "mapping",
                ...
                },
                {
                    ...
                    showElement: {
                        ...
                        hidden: account =>
                            !!account.screen_msg_regexs?.length,
                        columns: [
                            {
                                name: __("Find"),
                                value: "find",
    ...
    methods: {
        ...
        onSubmitCallback(e, accountToSave) {
            ...
            account.inhouse_patron_categories = account.inhouse_patron_categories?.join(",");
