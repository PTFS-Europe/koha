...
<xsl:stylesheet version="1.0"
  ...
  <xsl:include href="MARC21Languages.xsl"/>
    ...
    <xsl:template name="renderMARCOnlineResourceField">
        ...
        <xsl:if test="marc:datafield[@tag=$MARCOnlineResourceField]/marc:subfield[@code='u']">
            ...
            <a>
                    ...
                    <xsl:value-of
                        ...
                        <xsl:choose>
                            <xsl:when
                                test="$MARCOnlineResourceField = '856' and ($Show856uAsImage='Details' or $Show856uAsImage='Both') and (substring($SubqText,1,6)='image/' or $SubqText='img' or $SubqText='bmp' or $SubqText='cod' or $SubqText='gif' or $SubqText='ief' or $SubqText='jpe' or $SubqText='jpeg' or $SubqText='jpg' or $SubqText='jfif' or $SubqText='png' or $SubqText='svg' or $SubqText='tif' or $SubqText='tiff' or $SubqText='ras' or $SubqText='cmx' or $SubqText='ico' or $SubqText='pnm' or $SubqText='pbm' or $SubqText='pgm' or $SubqText='ppm' or $SubqText='rgb' or $SubqText='xbm' or $SubqText='xpm' or $SubqText='xwd')">
