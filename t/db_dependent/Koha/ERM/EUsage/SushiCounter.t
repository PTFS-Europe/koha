...
subtest 'TR_J2 _COUNTER_report_body' => sub {
    ...
    is( $report_body[2][7],  '1878-0504',                    '8th column is print ISSN' );
    is( $report_body[2][8],  '',                             '9th column is URI' );
...
subtest 'TR_J3 _COUNTER_report_body' => sub {
    ...
    is( $report_body[0][9], 'OA_Gold', '1st title, same access_type' );
    is( $report_body[1][9], 'OA_Gold', '1st title, same access_type' );
    is( $report_body[2][9], 'OA_Gold', '1st title, same access_type' );
    is( $report_body[3][9], 'OA_Gold', '1st title, same access_type' );
    is( $report_body[0][10], 'Total_Item_Requests', '1st title, same access_type' );
    is( $report_body[1][10], 'Unique_Item_Requests', '1st title, same access_type' );
    is( $report_body[2][10], 'Unique_Item_Investigations', '1st title, same access_type' );
    is( $report_body[3][10], 'Total_Item_Investigations', '1st title, same access_type' );
    ...
    is( $report_body[2][6],  '',                             '7th column is print ISSN' );
    is( $report_body[2][7], '2574-0962', '8th column is print ISSN' );
    is( $report_body[2][8],  '',                             '9th column is URI' );
    is( $report_body[2][9], 'OA_Gold', '10th column is access type' );
    is( $report_body[2][10], 'Unique_Item_Investigations', '10th column is access type' );
...
subtest 'TR_J4 _COUNTER_report_body' => sub {
    ...
    is( $report_body[0][10], 'Unique_Item_Requests', '1st title, same access_type' );
    is( $report_body[1][10], 'Total_Item_Requests', '1st title, same access_type' );
    is( $report_body[2][10], 'Unique_Item_Requests', '1st title, same access_type' );
    is( $report_body[3][10], 'Total_Item_Requests', '1st title, same access_type' );
