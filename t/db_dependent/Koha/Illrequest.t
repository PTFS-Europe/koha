...
subtest 'patron() tests' => sub {
    ...
    my $patroncategory = $builder->build_object(
        { class => 'Koha::Patron::Categories', value => { can_place_ill_in_opac => 1, BlockExpiredPatronOpacActions => 'ill_request' } } );
    my $patron = $builder->build_object( { class => 'Koha::Patrons', value => { categorycode => $patroncategory->id } } );
    my $request =
