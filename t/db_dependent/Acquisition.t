...
ok(Koha::Biblios->find($order2->{biblionumber})->deleted_on , "biblio does not exist anymore");
...
ok(Koha::Biblios->find($order4->{biblionumber})->deleted_on, "biblio does not exist anymore");
