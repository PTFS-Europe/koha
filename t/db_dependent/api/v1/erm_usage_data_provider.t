...
subtest 'list() tests' => sub {
    ...
    $t->get_ok("//$userid:$password@/api/v1/erm/usage_data_providers")->status_is(200)
      ->json_is(
        [
            $usage_data_provider->to_api,
            $another_usage_data_provider->to_api,
        ]
      );
    ...
    $t->get_ok( qq~//$userid:$password@/api/v1/erm/usage_data_providers?q=[{"me.name":{"like":"%ko%"}}]~)
      ->status_is(200)
      ->json_is( [ $usage_data_provider_to_search->to_api ] );
...
subtest 'get() tests' => sub {
    ...
    $t->get_ok( "//$userid:$password@/api/v1/erm/usage_data_providers/"
          . $usage_data_provider->erm_usage_data_provider_id )->status_is(200)
      ->json_is( $usage_data_provider->to_api );
    ...
    my $usage_data_provider_to_delete =
      $builder->build_object( { class => 'Koha::ERM::UsageDataProviders' } );
    ...
    $t->get_ok("//$userid:$password@/api/v1/erm/usage_data_providers/$non_existent_id")
      ->status_is(404)->json_is( '/error' => 'Usage data provider not found' );
...
subtest 'add() tests' => sub {
    ...
    $t->post_ok( "//$unauth_userid:$password@/api/v1/erm/usage_data_providers" => json =>
          $usage_data_provider )->status_is(403);
    ...
    $t->post_ok( "//$userid:$password@/api/v1/erm/usage_data_providers" => json =>
    ...
    my $usage_data_provider_id =
      $t->post_ok(
        "//$userid:$password@/api/v1/erm/usage_data_providers" => json => $usage_data_provider )
...
subtest 'update() tests' => sub {
    ...
    my $usage_data_provider_id =
      $builder->build_object( { class => 'Koha::ERM::UsageDataProviders' } )->erm_usage_data_provider_id;

    # Unauthorized attempt to update
    $t->put_ok(
        "//$unauth_userid:$password@/api/v1/erm/usage_data_providers/$usage_data_provider_id" =>
    ...
    $t->put_ok(
        "//$userid:$password@/api/v1/erm/usage_data_providers/$usage_data_provider_id" => json =>
    ...
    $t->put_ok(
        "//$userid:$password@/api/v1/erm/usage_data_providers/$usage_data_provider_id" => json =>
          $usage_data_provider_with_updated_field )->status_is(200)
    ...
    $t->put_ok( "//$userid:$password@/api/v1/erm/usage_data_providers/$non_existent_id" =>
          json => $usage_data_provider_with_updated_field )->status_is(404);
